...
# 2021, re-written to work with slurm .sh files instead of pbs files
...
# DTE 03/31/2020 the instructions to edit your .bashrc were wrong - thanks YC for pointing this out to me - it should be export PATH=~/bin:$PATH   colon instead of =!
...
function tabula_rasa (){
	rm "$name".sh #this will delete the in situ generated .pbs file
}
