...
# this script is designed to create a .xyz file from a given .com or .gjf file 
...
input="$1" #declares the string with name of input file
  if [ "${input: -4}" == ".gjf" ];
	then
	name=${input%%.gjf} #cuts off the .xyz part of the input file and saves it to variable name
	fi
