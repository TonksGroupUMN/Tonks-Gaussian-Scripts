...
function get_par (){
	...
	#echo $w_mem
 	...
 	echo -e "\e[92mChange functional? (default is m06, use modcom or manually change calc type, set as calcfc,maxcyc=512 \e[0m"
	read w_fun
	...
	w_fun="m06"
 	...
 	echo -e "\e[92mChange basis? (default is 6-311g(d,p), use modcom or manually change calc type, set as calcfc,maxcyc=512 \e[0m"
	read w_basis
...
echo
echo -e "\e[1;4mDo you want to include a solvent? (if enter will default to bromobenzene)" 
...
# Note variable is quoted.
  ...
  # Accept upper or lowercase input or 1.
    echo "Enter solvent or press enter for bromobenzene"
...
%mem=$w_mem
%chk=$name.chk
# opt=(calcfc,maxcyc=512) freq $w_fun/$w_basis $w_solcard$w_sol$w_solend
